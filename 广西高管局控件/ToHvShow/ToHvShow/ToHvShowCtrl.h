...
// ToHvShowCtrl.h : Declaration of the CToHvShowCtrl ActiveX Control class.


// CToHvShowCtrl : See ToHvShowCtrl.cpp for implementation.

class CToHvShowCtrl : public COleControl
{
	DECLARE_DYNCREATE(CToHvShowCtrl)
...
protected:
	...
	DECLARE_OLECREATE_EX(CToHvShowCtrl)    // Class factory and guid
	DECLARE_OLETYPELIB(CToHvShowCtrl)      // GetTypeInfo
	DECLARE_PROPPAGEIDS(CToHvShowCtrl)     // Property page IDs
	DECLARE_OLECTLTYPE(CToHvShowCtrl)		// Type name and misc status
