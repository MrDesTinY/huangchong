========================================================================
    ACTIVEX CONTROL DLL : PrinterOperation Project Overview
========================================================================

ControlWizard has created this project for your PrinterOperation ActiveX Control
...
that make up your PrinterOperation ActiveX Control DLL.

PrinterOperation.vcproj
...
PrinterOperation.def
    This file contains information about the ActiveX Control DLL that
    must be provided to run with Microsoft Windows.

PrinterOperation.idl
    This file contains the Object Description Language source code for the
    type library of your control.

PrinterOperation.ico
    This file contains an icon that will appear in the About box.  This icon
    is included by the main resource file PrinterOperation.rc.

/////////////////////////////////////////////////////////////////////////////
CPrinterOperationCtrl control:

PrinterOperationCtrl.h
    This file contains the declaration of the CPrinterOperationCtrl C++ class.

PrinterOperationCtrl.cpp
    This file contains the implementation of the CPrinterOperationCtrl C++ class.

PrinterOperationPropPage.h
    This file contains the declaration of the CPrinterOperationPropPage C++ class.

PrinterOperationPropPage.cpp
    This file contains the implementation of the CPrinterOperationPropPage C++ class.

CPrinterOperationCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CPrinterOperationCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file PrinterOperation.rc.
...
stdafx.h, stdafx.cpp
    ...
    named PrinterOperation.pch and a precompiled types (PCT) file named stdafx.obj.
