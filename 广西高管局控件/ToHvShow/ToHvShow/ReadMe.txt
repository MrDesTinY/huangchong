========================================================================
    ACTIVEX CONTROL DLL : ToHvShow Project Overview
========================================================================

ControlWizard has created this project for your ToHvShow ActiveX Control
...
that make up your ToHvShow ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CToHvShowCtrl control:

ToHvShowCtrl.h
    This file contains the declaration of the CToHvShowCtrl C++ class.

ToHvShowCtrl.cpp
    This file contains the implementation of the CToHvShowCtrl C++ class.

ToHvShowPropPage.h
    This file contains the declaration of the CToHvShowPropPage C++ class.

ToHvShowPropPage.cpp
    This file contains the implementation of the CToHvShowPropPage C++ class.

CToHvShowCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CToHvShowCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file ToHvShow.rc.
...
stdafx.h, stdafx.cpp
    ...
    named ToHvShow.pch and a precompiled types (PCT) file named stdafx.obj.
