// HVActiveX2Ctrl.cpp : Implementation of the CHVActiveX2Ctrl ActiveX Control class.

#include "stdafx.h"
#include "HVActiveX2.h"
#include "HVActiveX2Ctrl.h"
#include "HVActiveX2PropPage.h"
std::vector<pDeviceInfo> CHVActiveX2Ctrl::m_vecDeviceInfoTable;
...
IMPLEMENT_DYNCREATE(CHVActiveX2Ctrl, COleControl)



// Message map

BEGIN_MESSAGE_MAP(CHVActiveX2Ctrl, COleControl)
...
BEGIN_DISPATCH_MAP(CHVActiveX2Ctrl, COleControl)
	DISP_PROPERTY_NOTIFY_ID(CHVActiveX2Ctrl, "RecvSnapImageFlag", dispidRecvSnapImageFlag, m_RecvSnapImageFlag, OnRecvSnapImageFlagChanged, VT_I4)
	DISP_PROPERTY_NOTIFY_ID(CHVActiveX2Ctrl, "RecvPlateImageFlag", dispidRecvPlateImageFlag, m_RecvPlateImageFlag, OnRecvPlateImageFlagChanged, VT_I4)
	DISP_PROPERTY_NOTIFY_ID(CHVActiveX2Ctrl, "RecvPlateBinImageFlag", dispidRecvPlateBinImageFlag, m_RecvPlateBinImageFlag, OnRecvPlateBinImageFlagChanged, VT_I4)
	DISP_PROPERTY_NOTIFY_ID(CHVActiveX2Ctrl, "RecvSnapDriverImageFlag", dispidRecvSnapDriverImageFlag, m_RecvSnapDriverImageFlag, OnRecvSnapDriverImageFlagChanged, VT_I4)
	DISP_PROPERTY_NOTIFY_ID(CHVActiveX2Ctrl, "AutoSaveFlag", dispidAutoSaveFlag, m_AutoSaveFlag, OnAutoSaveFlagChanged, VT_BOOL)
	DISP_PROPERTY_NOTIFY_ID(CHVActiveX2Ctrl, "ShowPlateImage", dispidShowPlateImage, m_ShowPlateImage, OnShowPlateImageChanged, VT_BSTR)
	DISP_PROPERTY_NOTIFY_ID(CHVActiveX2Ctrl, "ShowFirstImage", dispidShowFirstImage, m_ShowFirstImage, OnShowFirstImageChanged, VT_BSTR)
	DISP_PROPERTY_NOTIFY_ID(CHVActiveX2Ctrl, "ShowSecondImage", dispidShowSecondImage, m_ShowSecondImage, OnShowSecondImageChanged, VT_BSTR)
	DISP_PROPERTY_NOTIFY_ID(CHVActiveX2Ctrl, "ShowPlateResult", dispidShowPlateResult, m_ShowPlateResult, OnShowPlateResultChanged, VT_BSTR)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "ConnectTo", dispidConnectTo, ConnectTo, VT_EMPTY, VTS_BSTR)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "GetStatus", dispidGetStatus, GetStatus, VT_I4, VTS_NONE)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "Disconnect", dispidDisconnect, Disconnect, VT_EMPTY, VTS_NONE)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "SetImgSavePath", dispidSetImgSavePath, SetImgSavePath, VT_EMPTY, VTS_BSTR)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "GetPlate", dispidGetPlate, GetPlate, VT_BSTR, VTS_NONE)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "GetPlateColor", dispidGetPlateColor, GetPlateColor, VT_BSTR, VTS_NONE)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "GetPlateInfo", dispidGetPlateInfo, GetPlateInfo, VT_BSTR, VTS_NONE)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "SaveSnapImage", dispidSaveSnapImage, SaveSnapImage, VT_I4, VTS_BSTR)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "SaveSnapImage2", dispidSaveSnapImage2, SaveSnapImage2, VT_I4, VTS_BSTR)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "SavePlateImage", dispidSavePlateImage, SavePlateImage, VT_I4, VTS_BSTR)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "SavePlateBinImage", dispidSavePlateBinImage, SavePlateBinImage, VT_I4, VTS_BSTR)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "SavePlateBin2BMP", dispidSavePlateBin2BMP, SavePlateBin2BMP, VT_I4, VTS_BSTR)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "GetImageRecTime", dispidGetImageRecTime, GetImageRecTime, VT_BSTR, VTS_I4)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "GetImageFileName", dispidGetImageFileName, GetImageFileName, VT_BSTR, VTS_I4)
	DISP_FUNCTION_ID(CHVActiveX2Ctrl, "GetImageDataFromMem", dispidGetImageDataFromMem, GetImageDataFromMem, VT_BSTR, VTS_I4 VTS_PVARIANT VTS_PI4)
	DISP_PROPERTY_NOTIFY_ID(CHVActiveX2Ctrl, "LogFile", dispidLogFile, m_LogFile, OnLogFileChanged, VT_I4)
END_DISPATCH_MAP()
...
BEGIN_EVENT_MAP(CHVActiveX2Ctrl, COleControl)
...
BEGIN_PROPPAGEIDS(CHVActiveX2Ctrl, 1)
	PROPPAGEID(CHVActiveX2PropPage::guid)
END_PROPPAGEIDS(CHVActiveX2Ctrl)



// Initialize class factory and guid

IMPLEMENT_OLECREATE_EX(CHVActiveX2Ctrl, "HVActiveX2.HVActiveX2Ctrl.1",
...
IMPLEMENT_OLETYPELIB(CHVActiveX2Ctrl, _tlid, _wVerMajor, _wVerMinor)



// Interface IDs

const IID BASED_CODE IID_DHVActiveX2 =
		{ 0xC683820E, 0x70D4, 0x43E5, { 0xA0, 0x3D, 0xBB, 0xB9, 0x45, 0xF2, 0xEB, 0x2A } };
const IID BASED_CODE IID_DHVActiveX2Events =
...
static const DWORD BASED_CODE _dwHVActiveX2OleMisc =
...
IMPLEMENT_OLECTLTYPE(CHVActiveX2Ctrl, IDS_HVActiveX2, _dwHVActiveX2OleMisc)



// CHVActiveX2Ctrl::CHVActiveX2CtrlFactory::UpdateRegistry -
// Adds or removes system registry entries for CHVActiveX2Ctrl

BOOL CHVActiveX2Ctrl::CHVActiveX2CtrlFactory::UpdateRegistry(BOOL bRegister)
{
...
// CHVActiveX2Ctrl::CHVActiveX2Ctrl - Constructor

CHVActiveX2Ctrl::CHVActiveX2Ctrl()
{
	InitializeIIDs(&IID_DHVActiveX2, &IID_DHVActiveX2Events);
...
// CHVActiveX2Ctrl::~CHVActiveX2Ctrl - Destructor
...
// CHVActiveX2Ctrl::OnDraw - Drawing function
...
// CHVActiveX2Ctrl::DoPropExchange - Persistence support

void CHVActiveX2Ctrl::DoPropExchange(CPropExchange* pPX)
{
	...
	PX_Short(pPX,_T("AutoSaveFlag"),m_AutoSaveFlag,1);
...
// CHVActiveX2Ctrl::OnResetState - Reset control to default state

void CHVActiveX2Ctrl::OnResetState()
{
...
//消息处理函数来发送消息。
LRESULT CHVActiveX2Ctrl::OnRecieve(WPARAM wParam, LPARAM lParam)
{
	//向控件发送数据，之后再向外发送消息。
...
// CHVActiveX2Ctrl message handlers

void CHVActiveX2Ctrl::OnRecvSnapImageFlagChanged(void)
{
...
void CHVActiveX2Ctrl::OnRecvPlateImageFlagChanged(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void CHVActiveX2Ctrl::OnRecvPlateBinImageFlagChanged(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void CHVActiveX2Ctrl::OnRecvSnapDriverImageFlagChanged(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void CHVActiveX2Ctrl::OnAutoSaveFlagChanged(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void CHVActiveX2Ctrl::OnShowPlateImageChanged(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void CHVActiveX2Ctrl::OnShowFirstImageChanged(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void CHVActiveX2Ctrl::OnShowSecondImageChanged(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void CHVActiveX2Ctrl::OnShowPlateResultChanged(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void CHVActiveX2Ctrl::OnLogFileChanged(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void CHVActiveX2Ctrl::ConnectTo(LPCTSTR strAddr)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	CString tmp;
...
LONG CHVActiveX2Ctrl::GetStatus(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
void CHVActiveX2Ctrl::Disconnect(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	// TODO: Add your dispatch handler code here
	CleanAlarm();	
...
void CHVActiveX2Ctrl::SetImgSavePath(LPCTSTR strPath)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
BSTR CHVActiveX2Ctrl::GetPlate(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
BSTR CHVActiveX2Ctrl::GetPlateColor(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
BSTR CHVActiveX2Ctrl::GetPlateInfo(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
LONG CHVActiveX2Ctrl::SaveSnapImage(LPCTSTR strFileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
LONG CHVActiveX2Ctrl::SaveSnapImage2(LPCTSTR strFileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
LONG CHVActiveX2Ctrl::SavePlateImage(LPCTSTR strFileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
LONG CHVActiveX2Ctrl::SavePlateBinImage(LPCTSTR strFileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
LONG CHVActiveX2Ctrl::SavePlateBin2BMP(LPCTSTR strFileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
BSTR CHVActiveX2Ctrl::GetImageRecTime(LONG lImgType)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
BSTR CHVActiveX2Ctrl::GetImageFileName(LONG lImgType)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
BSTR CHVActiveX2Ctrl::GetImageDataFromMem(LONG lImgType, VARIANT* pVarImg, LONG* lImgSize)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool CHVActiveX2Ctrl::SendData( CString CtrlName, char *pdata, long datalen, long iType, resultMSG *pmsg )
{
	bool freturn(false);
	bool find(false);
...
/*获取所有OLE控件*/
void CHVActiveX2Ctrl::EnumAllControlNames()
{
	//如果是取窗口句柄
...
/** @fn		VOID CHVActiveX2Ctrl::WriteLogFile(LPCTSTR szLog) 
 *	@brief	写日志
 *	@param	[IN]	szFun	函数名
 ...
 *	@return	void
 */
VOID CHVActiveX2Ctrl::WriteLogFile(LPCTSTR szFun, BOOL bError, LPCTSTR szLog) 
{
...
/** @fn		BOOL CHVActiveX2Ctrl::CreateLogFile()
 *	@brief	创建日志文件
 *	@return	BOOL	true表示正确，否则失败
 */
BOOL CHVActiveX2Ctrl::CreateLogFile()
{
	if (m_hLogFile != NULL)
	{
		return TRUE;
...
/** @fn		BOOL CHVActiveX2Ctrl::CreateFileDir(LPCTSTR lpPath)
 *	@brief	创建指定的文件夹
 *	@param	[IN]	lpPath	文件路径
 *	@return	BOOL	TRUE表示成功，否则失败
 */
BOOL CHVActiveX2Ctrl::CreateFileDir(LPCTSTR lpPath)
{
	if (lpPath == NULL)
	{
		return FALSE;
...
int CHVActiveX2Ctrl::GetEncoderClsid(const WCHAR* format, CLSID* pClsid)
{
	UINT  nNum = 0;          
	UINT  nSize = 0;         
...
BOOL CHVActiveX2Ctrl::ConvertImgBytes2HBITMAP(BYTE* pImageBuffer,DWORD dwImageDataLen, int iWidth, int iHeight, WCHAR *  szFilePath)
{
...
/** @fn		void CHVActiveX2Ctrl::InsertNewPlate(LPNET_DVR_PLATE_RESULT pPlateInfo)
 *	@brief	插入新车牌信息
 *	@param	[IN]	pPlateInfo		车牌信息
 *	@return	void
 */
void CHVActiveX2Ctrl::InsertNewPlate(LPNET_DVR_PLATE_RESULT pPlateInfo)
{
	if (pPlateInfo == NULL)
	{
...
{
	CHVActiveX2Ctrl	*pMian	= (CHVActiveX2Ctrl*)pUser;
	if (pMian == NULL)
	{
		return ;
	}
...
/** @fn		VOID CHVActiveX2Ctrl::SetUpAlarm()
 *	@brief	设置布防
 *	@return	LONG	0表示成功，否则失败
 */
LONG CHVActiveX2Ctrl::SetUpAlarm()
{
	BOOL	bRet = FALSE;
	//开启布防
#ifndef ONE_DEVICE
...
/** @fn		LONG CHVActiveX2Ctrl::CleanAlarm()
 *	@brief	撤销布防
 *	@return	LONG	0表示成功， 否则失败
 */
LONG CHVActiveX2Ctrl::CleanAlarm()
{
	BOOL	bRet = TRUE;
#ifndef ONE_DEVICE
	EnterCriticalSection(&m_csVecLock);
 ...
 *	@return	BOOL	true表示成功，否则失败
 */
BOOL CHVActiveX2Ctrl::SavePic(LPCTSTR strFileName, BYTE * pImage, DWORD dwPicDataLen)
{
...
备注： 无
***************************************************/
int CHVActiveX2Ctrl::BinImageFormatConvert(BYTE *pByteBinPacked,int iWidth, int iHeight)
{
	int i;
...
备注：
*******************************************************************************/
int CHVActiveX2Ctrl::ConvertBin2BmpData(BYTE *pByteBinPacked, BYTE *pByteBmpData, unsigned int *pnBmpDataLength)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	//
...
/** @fn		void CHVActiveX2Ctrl::OnDestroy()
 *	@brief	销毁消息
 *	@return	void
 */
void CHVActiveX2Ctrl::OnDestroy()
{
#ifndef ONE_DEVICE
	Disconnect();
#else
...
#ifndef ONE_DEVICE
CString CHVActiveX2Ctrl::GetIPAddrByUid(LONG uid)//获取设备IP
{
	EnterCriticalSection(&m_csVecLock);
	CString csRet = _T("");
	std::vector<pDeviceInfo>::iterator iter = m_vecDeviceInfoTable.begin();
...
CString CHVActiveX2Ctrl::GetPortByUid(LONG uid)//获取设备端口
{
	EnterCriticalSection(&m_csVecLock);
	CString csRet = _T("");
	std::vector<pDeviceInfo>::iterator iter = m_vecDeviceInfoTable.begin();
...
LONG CHVActiveX2Ctrl::GetAlarmHandleByUid(LONG uid)//获取布防句柄
{
	EnterCriticalSection(&m_csVecLock);
	LONG lRet = -1;
	std::vector<pDeviceInfo>::iterator iter = m_vecDeviceInfoTable.begin();
...
CBufferManager * CHVActiveX2Ctrl::GetBufferManagerByUid(LONG uid)//获取缓存管理类 
{
	CString strTmp;
...
pDeviceInfo CHVActiveX2Ctrl::GetDevicePtrByUid(LONG uid)//获取设备信息结构体指针
{
	EnterCriticalSection(&m_csVecLock);
