========================================================================
    ACTIVEX CONTROL DLL : SCCP Project Overview
========================================================================

ControlWizard has created this project for your SCCP ActiveX Control
...
that make up your SCCP ActiveX Control DLL.
...
SCCP.ico
    ...
    is included by the main resource file SCCP.rc.

/////////////////////////////////////////////////////////////////////////////
CSCCPCtrl control:

SCCPCtrl.h
    This file contains the declaration of the CSCCPCtrl C++ class.

SCCPCtrl.cpp
    This file contains the implementation of the CSCCPCtrl C++ class.

SCCPPropPage.h
    This file contains the declaration of the CSCCPPropPage C++ class.

SCCPPropPage.cpp
    This file contains the implementation of the CSCCPPropPage C++ class.

CSCCPCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CSCCPCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file SCCP.rc.
...
stdafx.h, stdafx.cpp
    ...
    named SCCP.pch and a precompiled types (PCT) file named stdafx.obj.
